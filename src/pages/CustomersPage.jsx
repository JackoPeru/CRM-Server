      ...
      <div className="bg-white dark:bg-dark-card rounded-lg shadow-sm">
        <div className="p-4 border-b border-light-border dark:border-dark-border">
          <div className="flex gap-4">
            ...
            <button onClick={() => openModal('filterCustomers')} className="px-4 py-2 border border-light-border dark:border-dark-border rounded-md flex items-center gap-2 hover:bg-light-bg dark:hover:bg-dark-bg">
